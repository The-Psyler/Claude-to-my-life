...
const translations = {
  ...
  en: {
    ...
    settings_howto: 'How to use',
    settings_howto_btn: 'Open guide',
    ...
    settings_import_confirm: 'This will overwrite ALL current data. Continue?',
    ...
    toast_no_boot: 'Start your first Morning Boot before closing the day',
    ...
    toast_day_locked: 'Day is locked — unlock first',
  ...
  hu: {
    ...
    settings_howto: 'Használati útmutató',
    settings_howto_btn: 'Útmutató megnyitása',
    ...
    settings_backup: 'Mentés',
    settings_export: 'Exportálás JSON',
    settings_import: 'Importálás JSON',
    settings_import_confirm: 'Ez felülírja az összes jelenlegi adatot. Folytatod?',
    ...
    toast_no_boot: 'Előbb indítsd el a napot a Reggeli indításon',
    ...
    toast_day_locked: 'A nap le van zárva — előbb nyisd meg',
